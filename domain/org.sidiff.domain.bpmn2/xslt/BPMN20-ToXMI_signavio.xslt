...
<xsl:stylesheet version="2.0"
	...
	<xsl:template name="FlowElementsContainerTemplate">
		...
		<xsl:for-each select="bpmn:task">
			<flowElements xmi:type="bpmnxmi:Task">
				<xsl:call-template name="SignavioNode" />
	...
	<xsl:template name="SignavioNode">
		<xsl:if test="@name">
			<xsl:attribute name="name"> <xsl:value-of select="@name" /> </xsl:attribute>
		</xsl:if>
	...
	<xsl:template name="DefinitionsTemplate">
		...
		<!--<xsl:for-each select="bpmndi:BPMNDiagram"> <diagrams xmi:type="bpmndixmi:BPMNDiagram"> 
			<xsl:call-template name="BPMNDiagramTemplate" /> </diagrams> </xsl:for-each> -->
	</xsl:template>
	...
	<!-- <xsl:template name="BPMNDiagramTemplate"> <xsl:call-template name="DiagramTemplate" 
		/> <xsl:for-each select="bpmndi:BPMNPlane"> <plane xmi:type="bpmndixmi:BPMNPlane"> 
		<xsl:call-template name="BPMNPlaneTemplate" /> </plane> </xsl:for-each> <xsl:for-each 
		select="bpmndi:BPMNLabelStyle"> <labelStyle xmi:type="bpmndixmi:BPMNLabelStyle"> 
		<xsl:call-template name="BPMNLabelStyleTemplate" /> </labelStyle> </xsl:for-each> 
		</xsl:template> -->
