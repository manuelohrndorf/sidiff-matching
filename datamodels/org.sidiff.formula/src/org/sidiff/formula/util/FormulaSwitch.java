...
public class FormulaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FormulaPackage.BINARY_FORMULA: {
			...
			case FormulaPackage.UNARY_FORMULA: {
			...
			case FormulaPackage.IMPLIES: {
				Implies implies = (Implies)theEObject;
				T result = caseImplies(implies);
				if (result == null) result = caseBinaryFormula(implies);
				if (result == null) result = caseFormula(implies);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormulaPackage.CONFIGURATION: {
				Configuration configuration = (Configuration)theEObject;
				T result = caseConfiguration(configuration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormulaPackage.VARIABLE_ASSIGNMENT: {
				@SuppressWarnings("unchecked") Map.Entry<Variable, Boolean> variableAssignment = (Map.Entry<Variable, Boolean>)theEObject;
	 ...
	 * @generated
	 */
	public T caseVariableAssignment(Map.Entry<Variable, Boolean> object) {
		return null;
	}
