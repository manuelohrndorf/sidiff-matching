...
/**
 * This is the item provider adapter for a {@link org.sidiff.formula.And} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AndItemProvider extends BinaryFormulaItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_And_priority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_And_priority_feature", "_UI_And_type"),
				 FormulaPackage.Literals.AND__PRIORITY,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ISatSolverAdapter labelValue = ((And)object).getSatSolverAdapter();
