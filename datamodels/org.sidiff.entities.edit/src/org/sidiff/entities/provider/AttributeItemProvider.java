...
/**
 * This is the item provider adapter for a {@link org.sidiff.entities.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends EntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntitiesPackage.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntitiesPackage.Literals.ATTRIBUTE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addContainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_container_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_container_feature", "_UI_Attribute_type"),
				 EntitiesPackage.Literals.ATTRIBUTE__CONTAINER,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		...
		Object image = null;
		if(att.getType() != null){
			image = ItemProviderUtil.getImageByObject(att.getType());
		}
		return (image != null) ? image : overlayImage(object, getResourceLocator().getImage("full/obj16/Attribute"));
	}
	...
	public String getText(Object object) {
		...
		String label = attribute.getType().getName() + " = " + String.join(",", attribute.getValue());
		return label;
	}
