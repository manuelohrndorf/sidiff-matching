...
public class EntitiesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EntitiesPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = caseEntity(element);
				if (result == null) result = caseIdentifiableEntity(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntitiesPackage.REFERENCE: {
				...
				if (result == null) result = caseEntity(reference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case EntitiesPackage.ANNOTATION: {
				Annotation annotation = (Annotation)theEObject;
				T result = caseAnnotation(annotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EntitiesPackage.IDENTIFIABLE_ENTITY: {
