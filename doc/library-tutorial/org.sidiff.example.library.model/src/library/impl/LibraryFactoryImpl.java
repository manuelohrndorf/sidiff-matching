...
public class LibraryFactoryImpl extends EFactoryImpl implements LibraryFactory {
	...
	public static LibraryFactory init() {
		try {
			LibraryFactory theLibraryFactory = (LibraryFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/emf/jcrm/samples/emf/sample/Library"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case LibraryPackage.CHAPTER: return createChapter();
			default:
