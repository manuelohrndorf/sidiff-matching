...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
	 ...
	 * @generated
	 */
	public EReference getChapter_Predecessor() {
	 ...
	 * @generated
	 */
	public EReference getChapter_Successor() {
	...
	public void createPackageContents() {
		...
		createEReference(chapterEClass, CHAPTER__PREDECESSOR);
		createEReference(chapterEClass, CHAPTER__SUCCESSOR);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getChapter_Title(), theXMLTypePackage.getString(), "title", null, 0, 1, Chapter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChapter_Predecessor(), this.getChapter(), this.getChapter_Successor(), "predecessor", null, 0, 1, Chapter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChapter_Successor(), this.getChapter(), this.getChapter_Predecessor(), "successor", null, 0, 1, Chapter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
