	...
	public Resource getEResourceA() {
        if (eResourceA == null) {
            ...
            if (eResourceA == null) {
				...
				if(modelURI.isRelative() && res != null) {
            		modelURI = modelURI.resolve(res.getURI());
            	}
				ResourceSet resSet = res == null ? null : res.getResourceSet();
				if(resSet == null) {
					resSet = SiDiffResourceSet.create();
				}
                eResourceA = resSet.getResource(modelURI, true);
            }
        }
	...
	public Resource getEResourceB() {
        if (eResourceB == null) {
            ...
            if (eResourceB == null) {
                ...
                eResourceB = resSet.getResource(modelURI, true);
            }
        }
